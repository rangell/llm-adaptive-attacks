...
singularity exec --nv\
            ...
            -c 'source /ext3/env.sh; python -u compute_jailbreak_robustness.py --target-model __model_name__ --jailbreak-dataset __jailbreak_dataset__ --output-dir __output_dir__'\
"""


if __name__ == "__main__":

    output_dir = "/scratch/rca9780/llm-adaptive-attacks-data/jailbreak_robustness_data/"
    models = [
        #"llama3-8b",
        #"llama3-70b",
        #"llama3.1-8b",
    ...
    for model_name in models:
        ...
        for jailbreak_dataset in jailbreak_datasets:
            job_name = "jr-{}".format(model_name)
            out_path = f'{output_dir}/{model_name}-{jailbreak_dataset}'
